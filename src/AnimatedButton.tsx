...
const AnimatedButton: React.FC<AnimatedButtonProps> = ({
  ...
  return (
    <Component
      ...
      className={cn(
        "animated-btn group inline-flex items-center justify-center px-6 py-2 rounded-md relative overflow-hidden bg-neutral-50 dark:bg-black border border-neutral-200 dark:border-[#222]",
